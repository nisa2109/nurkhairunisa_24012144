...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .container { max-width: 680px; margin: 0 auto; padding: 26px; }
            .header {
                display: flex;
                align-items: center;
            ...
            .btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 12px; border-radius: 12px; border: 1px solid rgba(15, 23, 42, 0.14); background: rgba(255, 255, 255, 0.9); color: #0f172a; text-decoration: none; font-size: 14px; cursor: pointer; }
            ...
            .card { margin-top: 16px; background: rgba(255, 255, 255, 0.88); border: 1px solid rgba(15, 23, 42, 0.10); border-radius: 16px; padding: 16px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.08); }
            label { display: block; font-size: 14px; font-weight: 650; margin-bottom: 6px; color: #0f172a; }
            input {
                width: 100%;
                padding: 10px 12px;
            ...
            .help { margin-top: 6px; font-size: 12px; color: #475569; }
            ...
            <form method="POST" action="{{ route('users.update', $user) }}" class="card">
                ...
                <div class="field">
                    ...
                    <input
                        ...
                        type="password"
                    />
                    <p class="help">Kosongkan jika tidak ingin mengganti password.</p>
                </div>
